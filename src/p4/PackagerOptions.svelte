      ...
      <div>
        ...
        {#if $options.target.includes('win')}
          <div>
            ...
            <!-- TODO: remove ~november 6 -->
            <p><b>Update: Due to improvements in how files are strucutured in the application, old versions of TurboWarp Packager Extras will not work. Make sure to download the latest version.</b></p>
